...
#define EXCEPT_RISCV_IRQ_6                 0x8000000000000006UL
#define EXCEPT_RISCV_IRQ_TIMER_FROM_MMODE  0x8000000000000007UL
#define EXCEPT_RISCV_MAX_IRQS              (EXCEPT_RISCV_IRQ_INDEX(EXCEPT_RISCV_IRQ_TIMER_FROM_MMODE))
#else
